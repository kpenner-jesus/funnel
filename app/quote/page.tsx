...
// FIXED: Path adjusted from '@/store' to '../store' so Vercel can find it
...
export default function QuoteStep() {
  ...
  if (data.wantsMeals) {
    const totalMealsPerPerson = (nights * 3); 
  ...
  const actRates: Record<string, number> = { 
    "Canoe Rental": 25, 
    "Tubing & Rafting": 15, 
    "Pontoon Boat Experience": 150, 
    "Hoopla Island Obstacle": 20, 
    "Bannock Bake Activity": 10, 
    "Firepit with S'mores": 5, 
    "Wolf Howl Hike (Guided)": 12, 
    "Petroforms Guided Tour": 15 
  };
  ...
  return (
    <div className="min-h-screen bg-stone-50 pb-20 pt-12 px-4 font-sans text-stone-900">
      <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 shadow-2xl border border-stone-200">
        ...
        <div className="mt-10">
          <button 
            ...
            className="w-full bg-emerald-700 hover:bg-emerald-800 text-white font-bold py-5 rounded-2xl shadow-xl transition-all text-xl mb-4 active:scale-95"
          >
